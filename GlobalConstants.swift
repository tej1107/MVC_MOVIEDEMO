...
//Base API
    static var SERVER_URL = "https://api.themoviedb.org/3/discover/movie?api_key=15b&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page="

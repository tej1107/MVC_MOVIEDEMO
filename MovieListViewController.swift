...
class MovieListViewController: BaseViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if cell.viewBottom.frame.origin.y < 110{
            if(cell.lblDescription.text == "")
            {
                cell.lableBottom.isActive = false
                cell.imageBottom.isActive = true
            }
            else
            {
                cell.lableBottom.isActive = false
            ...
            cell.imageBottom.isActive = false
            cell.lableBottom.isActive = true
        }
        return cell
    }
